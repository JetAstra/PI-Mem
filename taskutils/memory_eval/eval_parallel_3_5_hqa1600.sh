#!/bin/bash
# bash /mnt/shared-storage-user/liudawei/home/verl-new/taskutils/memory_eval/eval_parallel_3_5_hqa1600.sh
...
for STEP in "${STEPS[@]}"; do
    ...
    LOG_DIR=results_qwen3.5-35B-hqa1600
    mkdir -p $LOG_DIR

    STEP="$STEP" python run_rjob_qwen35_hqa1600.py 2>&1 | tee $LOG_DIR/training_$(date +%Y%m%d_%H%M).txt
