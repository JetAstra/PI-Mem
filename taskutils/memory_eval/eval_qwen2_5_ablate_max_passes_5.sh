#!/bin/bash
# HQA ablation: allow up to five parallel extraction/merge passes.
...
export ABLATE_CONFIG=parallel_max_passes_5
export STEP=240

LOG_DIR="results_qwen2.5-7B-ablate/parallel-max-passes-5-step_${STEP}"
mkdir -p "$LOG_DIR"
