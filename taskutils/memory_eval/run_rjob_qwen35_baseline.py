...
Qwen35_35B_openai = Config(
    ...
    results_dir='taskutils/memory_eval/results_qwen3.5-35B-vanilla/qwen3.5-35B-baseline',
...
Qwen35_35B_openai_yarn = Config(
    ...
    num_samples=64,
    serve_max_model_len=4_000_000,
    results_dir='taskutils/memory_eval/results_qwen3.5-35B-vanilla/qwen3.5-35B-baseline-yarn4.0',
    # results_dir='results_qwen3.5-35B-bsz1/qwen3.5-35B-parallel-baseline',
)
