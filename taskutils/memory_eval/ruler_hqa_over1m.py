...
def main():
    ...
    sys.path.append(MEMORY_DATA_ROOT)
    from processing import read_hotpotqa

    _, DOCS = read_hotpotqa(os.path.join(MEMORY_DATA_ROOT, "hotpotqa_dev.json"))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--length", type=int, default=12800, choices=[12800, 25600, 51200, 66635]
    )
