...
Intern_S2_15k_4k_parallel_train = Config(
    ...
    num_samples=64,
    results_dir=f'results_interns2-preview-parallel-boxed-debug/step_{STEP}'
)
...
Qwen35_35B_15k_4k_parallel_boxed = Config(
    ...
    num_samples=64,
    # results_dir='results_qwen3.5-35B-parallel-boxed/qwen3.5-35B-parallel-baseline-boxed',
...
Qwen35_35B = Config(
    ...
    results_dir='results_qwen3.5-35B-vanilla/qwen3.5-35B-baseline-boxed',
    # results_dir='results_qwen3.5-35B-bsz1/qwen3.5-35B-parallel-baseline-boxed',
)
