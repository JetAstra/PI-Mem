...
from .envs import URL, API_KEY,MAX_INPUT_LEN,MAX_OUTPUT_LEN,ENABLE_THINK
        ...
        try:
            async with session.post(
                ...
                if status!= 200:
                    ...
                    return {'conversation': conversation, 'final': '', 'response': '', 'trace': conversation}
                ...
                return {'conversation': conversation, 'final': final_answer, 'response': final_answer, 'trace': conversation}
