#!/bin/bash
# bash /mnt/shared-storage-user/liudawei/home/verl-new/taskutils/memory_eval/eval_parallel_3_5_baseline1.sh
...
LOG_DIR=results_qwen3.5-35B-vanilla/qwen3.5-35B-baseline
# LOG_DIR=results_qwen3.5-35B-bsz1
mkdir -p $LOG_DIR

python run_rjob_qwen35_baseline1.py 2>&1 | tee $LOG_DIR/training_$(date +%Y%m%d_%H%M).txt
