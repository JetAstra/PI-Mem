...
RUN_RESULTS_SUFFIX = f"/repeat_runs/{RUN_NAME}" if RUN_NAME else ""
...
Qwen35_35B_15k_4k_parallel_train = Config(
    ...
    num_samples=64,
    results_dir=f'results-qwen3.5-parallel-repeat/qwen3.5-parallel-step_{STEP}{RUN_RESULTS_SUFFIX}'
...
Qwen35_35B_15k_4k_recurrent_train = Config(
    ...
    num_samples=64,
    results_dir=f'results_qwen3.5-35B-recurrent-boxed/step_{STEP}_re-evaluate'
    # results_dir=f'results_qwen3.5-35B_64gpu_prolong_512k_mix2_sft_mqmv-hf150-parallel-boxed/step_{STEP}'
)
...
Qwen35_35B_openai = Config(
    ...
    results_dir=f'results-qwen3.5-openai-repeat/qwen3.5-openai{RUN_RESULTS_SUFFIX}',
)
...
CONFIGS = [
    ...
    # Qwen35_35B_15k_4k_recurrent_train,
    # Qwen35_35B_15k_4k_parallel_train,
    # Intern_S2_15k_4k_parallel_train,
    # Qwen35_35B,
]
