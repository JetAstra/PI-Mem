...
def generate_dataset(num_samples: int, save_dir: str, incremental: int = 10, qas=None, docs=None):
    ...
    write_jsons = TqdmExecutor(max_workers=96).run(generate_input_output, range(length), num_docs=incremental)
...
if __name__ == "__main__":
    ...
    # 100: 14k
    generate_dataset(30000, '/mnt/shared-storage-user/liudawei/home/verl/data/hotpotqa_train_sample1/hotpotqa_train_doc1000', 1000, QAS_train, DOCS_train)
