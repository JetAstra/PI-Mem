#!/bin/bash
# bash /mnt/shared-storage-user/dllm-share/liudawei/verl/recipe/dapo/run_memory_qwen3moe-30b_dapo_debug.sh
set -x
set -e
...
EXPERIMENT_NAME="Qwen30BA3B-8GPU-1nodes-MemAgent-debug"
