#!/bin/bash
# /mnt/shared-storage-user/dllm-share/liudawei/verl/recipe/dapo/run_memory_qwen3-8b_dapo_filter_overlong.sh
set -x
set -e
...
MODEL_PATH=/mnt/shared-storage-user/dllm-share/Models/Qwen3/Qwen3-8B
TRAIN_PATH="data/hotpotqa/hotpotqa_train_32k.parquet"
VAL_PATH="data/hotpotqa/hotpotqa_dev.parquet"
EXPERIMENT_NAME="Qwen3-8B-8GPU-1nodes-MemAgent-debug"
