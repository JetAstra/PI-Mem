#!/bin/bash
# bash /mnt/shared-storage-user/dllm-share/liudawei/verl/run_memory_qwen3moe-30b_grpo_debug.sh
set -x
set -e
...
export WANDB_DIR="/mnt/shared-storage-user/dllm-share/liudawei/verl/wandb_offline"
...
EXPERIMENT_NAME="Qwen3-30BA3B-8GPU-1nodes-parallel-debug-nooffload"
...
python -u -m verl.trainer.main_ppo \
    ...
    trainer.project_name='memagent-log-import' \
