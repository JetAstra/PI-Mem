...
class VLLMDeployment:
    def __init__(
        ...
        import os
        del os.environ['CUDA_VISIBLE_DEVICES']  # https://github.com/vllm-project/vllm/issues/8402
...
if __name__ == "__main__":
    ...
    os.chdir(pwd)
    cmd = f"RAY_SERVE_QUEUE_LENGTH_RESPONSE_DEADLINE_S=100 exec serve run --name VLLMMultiDeployment {file}:build_app model={args.model} tensor-parallel-size={args.tp}"
    import subprocess
