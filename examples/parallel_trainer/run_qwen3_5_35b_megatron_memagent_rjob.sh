...
# bash /mnt/shared-storage-user/liudawei/home/verl-new/examples/parallel_trainer/run_qwen3_5_35b_megatron_memagent_rjob.sh
set -xueo pipefail
...
export VLLM_RPC_TIMEOUT=3200
export VLLM_EXECUTE_MODEL_TIMEOUT_SECONDS=3600
export VLLM_ENGINE_ITERATION_TIMEOUT_S=1600
...
exp_name='Qwen3_5-35B-A3B-megatron-memagent-rjob'
adv_estimator=grpo
...
RECURRENT=(
    ...
    recurrent.memory.path=memagent/impls/memory.py
    recurrent.memory.name=REGISTER
    recurrent.memory.async_path=memagent/impls/async_memory.py
    recurrent.memory.async_name=REGISTER
    ...
    recurrent.memory.config.pass_reward_coef=0.0
...
ROLLOUT=(
    ...
    actor_rollout_ref.rollout.max_num_seqs=384
